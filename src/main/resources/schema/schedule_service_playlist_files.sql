...
--
-- Table structure for table `playlist_files`
--
...
--
-- Dumping data for table `playlist_files`
--

LOCK TABLES `playlist_files` WRITE;
/*!40000 ALTER TABLE `playlist_files` DISABLE KEYS */;
/*!40000 ALTER TABLE `playlist_files` ENABLE KEYS */;
UNLOCK TABLES;
